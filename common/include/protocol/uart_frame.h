...
#define UART_FRAME_SOF_1_OFFSET            0U
#define UART_FRAME_SOF_2_OFFSET            1U
#define UART_FRAME_VERSION_OFFSET          2U
#define UART_FRAME_MESSAGE_TYPE_OFFSET     3U
#define UART_FRAME_PAYLOAD_LENGTH_OFFSET   4U
#define UART_FRAME_PAYLOAD_OFFSET          5U
