...
#
# Generated by Vivado on Fri Aug 28 14:46:28 KST 2026
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_12 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/1033/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_14 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../target_control_zynq_hw.gen/sources_1/bd/design_1/ipshared/5765/hdl" +incdir+"/tools/Xilinx/Vivado/2022.1/data/xilinx_vip/include" \
