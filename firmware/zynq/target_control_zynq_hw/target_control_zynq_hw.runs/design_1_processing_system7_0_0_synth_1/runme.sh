...
HD_PWD='/home/user/Desktop/latency-aware-target-control/firmware/zynq/target_control_zynq_hw/target_control_zynq_hw.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
